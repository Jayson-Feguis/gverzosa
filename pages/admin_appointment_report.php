...
<div class="flex-col w-full min-h-screen pl-[270px] mt-[90px] pr-[20px] pb-[150px] overflow-auto">
    ...
    <div class="flex gap-10">
        <div>
            ...
            <input id="fromDate" type="date" class="block border border-grey-light w-full p-3 rounded mb-4 grow-0" name="fromDate" placeholder="11/17/2022" required />
        </div>
        <div>
            <label for="toDate" class="flex w-[350px] grow">To Date</label>
            <input id="toDate" type="date" class="block border border-grey-light w-full p-3 rounded mb-4 grow-0" name="toDate" placeholder="11/20/2022" required />
        </div>
    </div>
    <?php
    ...
    <script>
        function generateReport() {
            ...
            window.open(`https://gverzosa.store/pages/print_appointment_report.php?from=${from}&to=${to}`);
        }
    </script>
</div>