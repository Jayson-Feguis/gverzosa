...
if (isset($_POST['editproduct'])) {
    ...
    $validate = "SELECT * FROM  tbl_product WHERE PRODUCT_NAME = '$productname' AND PRODUCT_ID != '$productid'";
    ...
    if (mysqli_num_rows($query_validate) > 0) {
        ...
        $_SESSION['alert-text'] = "Product is already exist.";
    ...
    $validate = "SELECT * FROM  tbl_product WHERE PRODUCT_NAME = '$productname' ";
    $query_validate = mysqli_query($conn, $validate);
