              ...
              <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100" aria-controls="dropdown-example-main" data-collapse-toggle="dropdown-example-main">
                ...
                <li>
                    ...
                    <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="admin_feedback.php" class="flex items-center p-2 pl-8 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Feedback</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="admin_user.php" class="flex items-center p-2 pl-8 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Users</a>
                        </li>
                    </ul>
                </li>
                <li>
